...
<div class="section-head">
    ...
    <a class="button primary" href="<?= e(url('admin/reports/create.php')) ?>">تقرير جديد</a>
</div>
    ...
    <div class="table-wrap">
        <table class="data-table">
            ...
            <?php foreach ($reports as $report): ?>
                <tr>
                    <td><strong><?= e($report['title']) ?></strong></td>
                    <td><?= e($report['template_name']) ?><small>الإصدار <?= (int) $report['version_number'] ?></small></td>
                    <td><?= e($report['class_name']) ?></td>
                    <td><?= e($report['subject_name']) ?></td>
                    <td class="num"><?= e($report['report_date']) ?></td>
                    <td class="actions-cell"><a href="<?= e(url('admin/reports/view.php?id=' . $report['id'])) ?>">فتح</a></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
...
<?php else: ?>
    <div class="empty-state">
        ...
        <a class="button primary" href="<?= e(url('admin/reports/create.php')) ?>">إنشاء أول تقرير</a>
    </div>
<?php endif; ?>
<?php page_footer(); ?>
