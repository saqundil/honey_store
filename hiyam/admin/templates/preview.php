...
$html=(new App\Services\TableRenderer())->render($template,$students,[],false); page_header('معاينة: '.$template['name'],'templates',['assets/css/report-sheet.css']);
?><div class="preview-page"><div class="report-info"><strong><?= e($template['name']) ?></strong><span>الإصدار <?= (int)$template['version_number'] ?></span></div>
...
<div class="report-sheet report-sheet--dense"><?php require dirname(__DIR__,2).'/includes/report-header.php'; ?><?= $html ?></div>
</div><?php page_footer(); ?>