...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        redirect('admin/templates/edit.php?import=1');
...
<div class="import-page">
    ...
    <header class="import-header">
        <a class="import-back" href="<?= e(url('admin/templates/index.php')) ?>">
        ...
        <section class="import-card">
            ...
            <div class="import-row">
                <label class="import-name">
                    اسم القالب
                    <input name="name" value="<?= e($name) ?>" placeholder="يُملأ تلقائيًا عند تركه فارغًا">
                </label>
