...
<div class="section-head">
    ...
    <a class="button primary" href="<?= e(url('admin/assessments/edit.php')) ?>">مخطط جديد</a>
</div>
    ...
    <div class="table-wrap">
        <table class="data-table">
            ...
            <?php foreach ($schemes as $scheme): ?>
                <tr>
                    <td>
                        <strong><?= e($scheme['name']) ?></strong>
                        <?php if ($scheme['description']): ?><small><?= e($scheme['description']) ?></small><?php endif; ?>
                    </td>
                    <td>
                        <?= e($scheme['subject_name']) ?>
                        <small><?= e($scheme['academic_year_name'] . ' · ' . $scheme['term_name']) ?></small>
                    </td>
                    <td class="num"><?= $scheme['version_number'] ? 'v' . (int) $scheme['version_number'] : '—' ?></td>
                    <td><span class="status <?= e($scheme['status']) ?>"><?= $scheme['status'] === 'active' ? 'نشط' : 'معطل' ?></span></td>
                    <td class="actions-cell"><a href="<?= e(url('admin/assessments/edit.php?id=' . $scheme['id'])) ?>">إنشاء إصدار</a></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
...
<?php else: ?>
    <div class="empty-state">
        ...
        <a class="button primary" href="<?= e(url('admin/assessments/edit.php')) ?>">إنشاء أول مخطط</a>
    </div>
<?php endif; ?>
<?php page_footer(); ?>
