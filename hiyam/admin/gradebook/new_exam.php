...
<div class="wizard" id="wizard">
    ...
    <section class="wizard-panel is-active" data-step="1">
        ...
        <div class="wizard-context">
            <div><small>الصف</small><strong><?= e($class['name']) ?></strong></div>
            <div><small>الفصل</small><strong><?= e($class['term_name']) ?></strong></div>
            <div><small>العام الدراسي</small><strong><?= e($class['academic_year_name']) ?></strong></div>
        ...
        <div class="wizard-fields">
            ...
            <label>التاريخ
                <input id="exam-date" type="date" value="<?= e(date('Y-m-d')) ?>">
            </label>
        </div>
        ...
        <footer class="wizard-foot">
            <a class="tbtn" href="<?= e(url('admin/gradebook/class.php?id=' . $classId)) ?>">إلغاء</a>
