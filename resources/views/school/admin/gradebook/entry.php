...
<section class="entry-context" aria-labelledby="entry-title">
    <div class="entry-context-title">
        <h2 id="entry-title"><?= school_e($context['assessment_name']) ?></h2>
        <p><?= school_e($className . ' · ' . $context['subject_name'] . ' · ' . $context['term_name'] . ' ' . $context['academic_year_name']) ?></p>
    </div>
    ...
    <div class="entry-actions">
        <span class="entry-status" data-status="<?= school_e($context['status']) ?>"><?= school_e($statusLabel) ?></span>
        <?php if ($locked): ?>
...
<nav class="entry-tabs" role="tablist" aria-label="قوالب الاختبار">
    <?php foreach ($templateAssignments as $index => $assignment): ?>
        ...
        ><?= school_e($assignment['label']) ?></button>
    <?php endforeach; ?>
</nav>
<?php endif; ?>
