...
<div class="classes-wrap">
    <?php if ($classes): ?>
        <div class="classes-grid" role="list">
            <?php foreach ($classes as $class):
                ...
                $url        = school_url('admin/gradebook/class.php?id=' . $classId);
                   ...
                   data-empty="<?= $total === 0 ? 'true' : 'false' ?>">
                    <header class="class-card-head">
                        ...
                        <div class="class-card-sub">
                            ...
                            · <?= school_e($class['academic_year_name']) ?>
                        </div>
                    </header>
                    ...
                    <footer class="class-card-foot">
                        <time datetime="<?= school_e((string) $class['last_activity_at']) ?>"><?= school_e($lastLabel) ?></time>
                        <span class="go">
                            فتح الاختبارات
    ...
    <?php else: ?>
        <div class="classes-empty">
            ...
            <a class="tbtn tbtn-primary" href="<?= school_e(school_url('admin/classes/index.php')) ?>">إضافة أول صف</a>
        </div>
    <?php endif; ?>
</div>
