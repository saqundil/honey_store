...
<section class="section">
	...
	<div class="quick-actions">
		<a href="<?= school_e(school_url('admin/templates/edit.php')) ?>">إنشاء قالب جديد</a>
		<a href="<?= school_e(school_url('admin/templates/import.php')) ?>">استيراد قالب من جدول</a>
		<a href="<?= school_e(school_url('admin/reports/create.php')) ?>">إنشاء تقرير</a>
		<!-- <a href="<?= school_e(school_url('admin/students/index.php')) ?>">إضافة طالب</a>
		<a href="<?= school_e(school_url('admin/gradebook/index.php')) ?>">فتح سجل العلامات</a> -->
	</div>
</section>
<?php page_footer(); ?>
